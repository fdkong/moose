...
class MultiAppOldMeshFunctionTransfer;

template <>
InputParameters validParams<MultiAppOldMeshFunctionTransfer>();
 ...
 */
class MultiAppOldMeshFunctionTransfer : public MultiAppConservativeTransfer
{
public:
  static InputParameters validParams();

  MultiAppOldMeshFunctionTransfer(const InputParameters & parameters);
