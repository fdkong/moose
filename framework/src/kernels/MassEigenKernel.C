...
MassEigenKernel::MassEigenKernel(const InputParameters & parameters) : EigenKernel(parameters), _coef(getParam<Real>("coefficient")) {}

Real
MassEigenKernel::computeQpResidual()
{
  return -_u[_qp] * _test[_i][_qp] * _coef;
}
