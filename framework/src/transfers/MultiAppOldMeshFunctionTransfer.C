...
#include "MultiAppOldMeshFunctionTransfer.h"
...
registerMooseObject("MooseApp", MultiAppOldMeshFunctionTransfer);

defineLegacyParams(MultiAppOldMeshFunctionTransfer);

InputParameters
MultiAppOldMeshFunctionTransfer::validParams()
{
...
MultiAppOldMeshFunctionTransfer::MultiAppOldMeshFunctionTransfer(const InputParameters & parameters)
...
void
MultiAppOldMeshFunctionTransfer::execute()
{
  _console << "Beginning Old MeshFunctionTransfer " << name() << std::endl;
  ...
  _console << "Finished Old MeshFunctionTransfer " << name() << std::endl;

  postExecute();
}

void
MultiAppOldMeshFunctionTransfer::transferVariable(unsigned int i)
{
